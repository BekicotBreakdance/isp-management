...
$q_maintenance = mysqli_query($conn, "
    SELECT
        ...
        -- Catatan: tabel maintenance tidak punya field status.
        -- Status ditampilkan sebagai 'Proses' (dummy) untuk semua baris.
    FROM maintenance m
            ...
            <table class="dash-table">
                ...
                <?php if ($q_pelanggan && mysqli_num_rows($q_pelanggan) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Catatan: tabel pelanggan tidak punya field status aktif/nonaktif.
                                 Toggle ditampilkan aktif (checked) untuk semua pelanggan. -->
                            <label class="toggle">
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr><td colspan="6" style="text-align:center;color:var(--gray-400);padding:20px;">Belum ada data pelanggan.</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
            ...
            <table class="dash-table">
                ...
                <?php if ($q_maintenance && mysqli_num_rows($q_maintenance) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Catatan: tabel maintenance tidak punya field status.
                                 Ditampilkan "Proses" sebagai dummy sementara. -->
                            <span class="status-pill status-proses">Proses</span>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr><td colspan="5" style="text-align:center;color:var(--gray-400);padding:20px;">Belum ada data maintenance.</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
            ...
            <table class="dash-table">
                ...
                <?php if ($q_queue && mysqli_num_rows($q_queue) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Catatan: tabel queue tidak punya field status.
                                 Ditampilkan "Aktif" sebagai dummy untuk semua baris. -->
                            <span class="badge badge-green">Aktif</span>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr><td colspan="5" style="text-align:center;color:var(--gray-400);padding:20px;">Belum ada data queue.</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
