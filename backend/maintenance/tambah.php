...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Buat query INSERT
    $query = "INSERT INTO maintenance (id_teknisi, id_pelanggan, tanggal_mt, detail_kendala_singkat, status)
              VALUES ($id_teknisi, $id_pelanggan, '$tanggal_mt', '$detail_kendala_singkat', '$status')";
